package com.example.homework5android2.boarding;
...
import com.example.homework5android2.client.ViewPagerClient;
import com.example.homework5android2.client.ViewPagerModel;
import com.example.homework5android2.databinding.FragmentMainBoardBinding;
...
public class MainBoardFragment extends Fragment implements ItemClickListener{
    ...
    public void itemClick() {
        Navigation.findNavController(requireView()).navigate(R.id.homeFragment);
        SharedPreferences sharedPreferences = getActivity().getSharedPreferences("click here", Context.MODE_PRIVATE);
